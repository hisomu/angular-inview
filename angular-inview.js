...
(function() {
      ...
      return {
        ...
        link: function(scope, element, attrs, containerController) {
          ...
          item = {
            ...
            callback: function($event, $inview, $inviewpart, $direction) {
              if ($event == null) {
                $event = {};
              }
  ...
  triggerInViewCallback = function(event, item, inview, isTopVisible, isBottomVisible) {
    var elOffsetTop, inviewpart, isForward;
    if (inview) {
      ...
      if (!(item.wasInView && item.wasInView === inviewpart && elOffsetTop === item.lastOffsetTop)) {
        ...
        return item.callback(event, true, inviewpart,  isForward ? 'down' : 'up');
      }
